...
namespace UrlImageViewHelper
{
	...
	{
		public static void SetUrlDrawable(this ImageView imageView, string url, int defaultDrawable,bool circle,int size,[OptionalAttribute]bool featuredUser)
		{
			UrlImageViewHelper.SetUrlDrawable(imageView, url, defaultDrawable,circle,size,featuredUser);
		}
		...
		public static void SetUrlDrawable(this ImageView imageView, string url, int defaultResource, bool circle, int size,long cacheDurationMs, IUrlImageViewCallback callback) 
		{
			UrlImageViewHelper.SetUrlDrawable(imageView, url, defaultResource, circle,size,cacheDurationMs, callback);
	    }
